...
As an aspiring PhD, I'm interested in researching moral reasoning, norms violation, and moral disengagement in the context of online social interaction. I'm also very passionate about research methods, meta-research, computational reproducibility, psychometrics, and advanced statistical analysis. My second line of interests are health misinformation, conspiracy beliefs, and public attitudes to science. Apart from my main responsibility, I'm determined to practise my [<i class="fab fa-r-project"></i>](https://www.r-project.org) programming skill and created this website using `blogdown` package. My favourite [<i class="fab fa-r-project"></i>](https://www.r-project.org) packages are including `lavaan`, `lme4`, `metaverse`, `tidyverse`, and `psych`.
