...
My research interests are health behaviour, sociology of mental health, political activism, and ideology. I am also interested in the issues of research methods, replicability and statistical analysis. Apart from my daily responsibilities, I am regularly practising my [<i class="fab fa-r-project"></i>](https://www.r-project.org) programming skill and created this website using `blogdown` package. My favourite [<i class="fab fa-r-project"></i>](https://www.r-project.org) packages are `lavaan`, `lme4`, `tidyverse`, and `psych`.
